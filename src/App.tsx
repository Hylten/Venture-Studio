  ...
  return (
    <div className="bg-dark min-h-screen text-white selection:bg-[#C4A265]/30 font-sans">
      ...
      <section className="relative h-screen flex flex-col justify-center px-8 md:px-24 overflow-hidden">
        ...
        {/* Scroll Indicator */}
        <motion.div 
          className="absolute bottom-12 left-0 w-full text-center z-20 flex flex-col items-center gap-2"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 1.5, duration: 1 }}
        >
          <div className="flex flex-col items-center gap-2 opacity-10 hover:opacity-100 transition-opacity duration-1000">
            <span className="text-white/40 text-[9px] tracking-[5px] uppercase font-bold">Scroll</span>
            <motion.div
              animate={{ y: [0, 5, 0] }}
              transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
      ...
      <a
        ...
        className="fixed bottom-6 right-8 z-[60] bg-dark border border-white/10 p-2.5 rounded-full shadow-2xl opacity-20 hover:opacity-100 hover:border-[#C4A265]/40 transition-all duration-700 group flex items-center justify-center translate-y-0 hover:-translate-y-1"
      >
