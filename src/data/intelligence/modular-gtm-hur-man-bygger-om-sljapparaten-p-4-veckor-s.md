Modular GTM: Hur man bygger om säljapparaten på 4 veckor
...
Jag kan skriva Part 2, men först behöver jag se Part 1 eller åtminstone texten upp till markören  så att fortsättningen blir korrekt sammanhängande.

Kan du klistra in texten fram till ?
